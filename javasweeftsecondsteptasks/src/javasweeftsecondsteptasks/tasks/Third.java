...
public class Third {
	...
	*/
	...
	// main მეთოდში დატესტვისას notContains მეთოდი იყო სტატიკური
	public int notContains(int[] array) {
		...
		// მასივის წევრები გადავიტანე HashSet-ში
		for(int number: array) {
			set.add(number);
		}
		
		// განვსაზღვრე 0-ზე მეტი მინიმალური მთელი რიცხვი და შევინახე min-ცვლადში.
		int min = 1;
		
		// while loop-ის დახმარებით ვამოწმებ, რომ თუ მინიმალური ცვლადი(min), რომელსაც ვეძებ, HashSet-შია,
		// მაშინ ის გაიზარდოს 1-ით, იქამდე ვიდრე არ მივიღებ რიცხვს, რომელიც HashSet-ში არ მოიპოვება.
		while(set.contains(min)) {
			min++;
		}
		
		// ვაბრუნებ მინიმალურ მთელ რიცხვს, რომელიც 0-ზე მეტია და მასივში არ არის.
		return min;
	...
	public static void main(String[] args) {
		...
		// int[] nums = {}; // ცარიელი მასივის შემთხვევაში, დააბრუნებს 1-ს;
