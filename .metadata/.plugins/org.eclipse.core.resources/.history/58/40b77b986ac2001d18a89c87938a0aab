...
public class Fourth {
	...
	*/
	...
	// main მეთოდში დატესტვისას addTwoBinaryStrings მეთოდი იყო სტატიკური
	public static String addTwoBinaryStrings(String a, String b) {
		...
		while(i>= 0 || j>=0) {
			...
			// ასევე ვამოწმებთ, რომ სტრიქონი არ დასრულებულა და ისე შესრულდეს ოპერაციები, რადგან თავიდან ავიცილოთ IndexOutOfBoundsException; 
		...
		// ვინაიდან და რადგანაც StringBuilder append() მეთოდი მარცხნიდან მარჯვნივ ჩაწერს შედეგს, ჩვენ კი მარჯვნიდან მარცხნივ მოვყვებით, დავაბრუნებთ საწინააღმდეგო(reverse),შემობრუნებულ მნიშვნლეობას.
	...
	public static void main(String[] args) {
		...
		// System.out.println(addTwoBinaryStrings("1010","1011")); // -> 10101
		// System.out.println(addTwoBinaryStrings("100","11")); // -> 111
